const experiences = [
  ...
  // },
  {
    ...
    company: "Flying Fox Labs Pvt Ltd.",
    description:
      "Delivered  frontend UI development and backend, building responsive interfaces and supporting API integration for full-stack application features and developed helm charts .",
...
export const Experience = () => {
  return (
    <section id="experience" className="py-32 relative overflow-hidden">
      <div
        className="absolute top-1/2 left-1/4 w-56 h-56 sm:w-72 sm:h-72 md:w-96 md:h-96
